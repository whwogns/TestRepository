	...
	<form method="post"  style="padding: 0px 20px" enctype="multipart/form-data">
			...
			<div class="form-group">
				<div class="input-group">
					...
					<textarea class="form-control" rows="5" cols="30"placeholder="회원메일"name="memail"></textarea>
				</div>
			</div>
			<div class="form-group">
				<div class="input-group">
					...
					<textarea class="form-control" rows="5" cols="30"placeholder="회원나이"name="mage"></textarea>
				</div>
			</div>
			<div class="form-group">
				<div class="input-group">
